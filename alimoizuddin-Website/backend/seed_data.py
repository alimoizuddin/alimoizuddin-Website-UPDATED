...
DEFAULT_PROFILE = {
    ...
    "notion": "https://www.notion.so/Ali-Moizuddin-Ghostwriter-AI-Content-Specialist-32b966fa7e83801b95e7f7be1caab23e",
    ...
    "heroSub": "Transforming chaotic human cognition into scalable, autonomous AI infrastructure — for the operators, founders, and editorial-grade clients who can't afford generic.",
}
...
DEFAULT_COMPETENCIES = [
    ...
    {"id": "content", "title": "Content & Strategy", "items": ["Independent Ghostwriting", "Executive Communications", "Brand Storytelling", "Pyramid Principle", "SCR Framework", "Edutainment", "Knowledge Distillation (80/20)", "Instructional Design", "Spaced Repetition · Anki", "Copywriting", "SOP Design", "Editorial Judgment"]},
...
DEFAULT_EXPERIENCE = [
    {"role": "Independent AI Ghostwriter & Content Systems Specialist", "org": "Self-Employed · Siliguri, India", "period": "Feb 2026 — Present", "bullets": ["Architected and scaled 15+ custom LLM pipelines (GPT-4 + Gemini) — reducing content production time by 60–80% and turning chaotic inputs into publish-ready assets.", "Built a Whisper + n8n + Python transcription pipeline at 90%+ accuracy, routing structured assets to Drive and cutting manual transcription time by 80%.", "Engineered 6 voice-specific AI writing systems replicating client tone, worldview, and cadence — eliminating generic AI outputs at scale.", "Maintained founder voice and stylistic integrity across long-form outputs via identity-preserving prompt architectures.", "Transformed raw founder inputs (voice notes, Notion dumps) into publish-ready content — 3× faster idea-to-publication turnaround.", "Deployed prompt-driven content workflows across 10+ client engagements with 50% faster publishing cycles and consistent output quality."]},

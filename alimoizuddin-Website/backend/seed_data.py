...
DEFAULT_ABOUT_PARAGRAPHS = [
    ...
    "Since Feb 2023, I have built 20+ AI-powered systems across personal operating systems, learning infrastructure, RAG, OCR/BM25 search, transcription, SDR research, job-application automation, browser-agent workflows, and full-stack prototypes. From Feb 2026, I expanded into content and ghostwriting systems: voice-to-asset pipelines, identity-preserving LLMs, and publishing workflows.",
    "Most systems were self-directed or unpaid delegated builds for friends and Radio Club team members, focused on practical workflow leverage, learning infrastructure, automation, and working prototypes. The work compounds 40–60% overhead reductions and includes a Be10x AI Generalist Hackathon win.",
...
DEFAULT_EXPERIENCE = [
    {"role": "AI Systems Architect & Automation Builder", "org": "Self-Employed · Siliguri, India", "period": "Feb 2023 — Present", "bullets": ["Built AI-powered systems across personal operating systems, learning infrastructure, RAG, OCR/BM25 search, transcription, SDR research, job-application automation, browser-agent workflows, and full-stack prototypes.", "Designed AI operating systems for learning, planning, execution, and knowledge management — reducing repetition and improving follow-through.", "Built RAG and search systems from notes, PDFs, transcripts, and media assets using OCR, BM25, transcript extraction, and long-context knowledge files.", "Automated workflows with n8n, Python, LLM APIs, and browser agents for transcription, SDR research, job applications, content structuring, and operational tasks.", "Since Feb 2026, expanded into content infrastructure: voice-to-asset pipelines and identity-preserving LLM systems that turn raw inputs into structured outputs.", "Most systems were self-directed; some were unpaid delegated builds for friends and Radio Club team members, focused on working prototypes and practical workflow improvement."]},

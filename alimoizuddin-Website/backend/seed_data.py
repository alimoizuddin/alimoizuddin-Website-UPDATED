...
DEFAULT_STATS = [
    ...
    {"value": "40 to 60%", "label": "Avg. Overhead Reduction"},
...
DEFAULT_ABOUT_PARAGRAPHS = [
    ...
    "The work is measured in concrete throughput: 500+ pages processed, 900+ media assets made queryable, 100+ hours of audio transcribed, and 40 to 60% manual overhead reduction across repeatable systems.",

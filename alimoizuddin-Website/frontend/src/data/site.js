...
export const PROJECTS = [
  ...
  {
    "id": "media-intake-one-tool",
    "category": "EDTECH",
    "title": "Media Intake One Tool",
    "description": "Windows drag-and-drop FFmpeg utility that turns .ts, .mkv, .mov, and long lecture files into clean MP4 video, MP3 audio, and 16 kHz mono FLAC for transcription.",
    "metric": "TS -> MP4 + MP3",
    "proofUrl": "https://github.com/alimoizuddin/media-intake-one-tool",
    "abstract": 4,
    "caseStudy": true,
    "detail": {
      "role": "Solo build - automation cleanup",
      "stack": [
        "Windows BAT",
        "FFmpeg",
        "FFprobe",
      ...
      "problem": "Lecture and cohort media were being handled by several overlapping BAT files, each optimized for a slightly different split, extract, or Colab-prep workflow.",
      "approach": [
        "Consolidated audio extraction, transcription audio prep, TS-to-MP4 conversion, and optional chunking into one drag-and-drop script.",
        "Kept the main FFmpeg settings editable at the top so the workflow can switch outputs without code changes.",
        "Added dated output folders, FFmpeg logs, and automatic MP3 splitting for large uploads."
      ],
      "result": [
        "One BAT now replaces the scattered extractor and splitter scripts.",
        "Each source can produce MP3, 16 kHz mono FLAC, and clean MP4 in a single run.",
        "Oversized MP3s are split into upload-friendly parts automatically."
      ]
    }
  },
  {

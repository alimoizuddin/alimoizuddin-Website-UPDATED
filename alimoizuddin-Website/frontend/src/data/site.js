...
export const PROJECTS = [
  ...
  },
  {
    ...
    "description": "Scalable bilingual (English/Hindi) transcription with 90%+ accuracy. Batch processing, Google Drive integration, 4 export formats (.txt, .srt, .vtt, .json) across 100+ hours.",
    "metric": "90%+ accuracy",
    "abstract": 3
  },
  {
  ...
  },
  {
    ...
    "description": "A .bat script autonomously extracting audio from 3-hour+ video lectures in under 30 seconds — processing 100+ hours of content.",
